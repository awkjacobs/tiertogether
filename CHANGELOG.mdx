...
- Removed React-Textfit package in favor of custom component to eliminate deprecated package

### Removed

- Removed the Roadmap menu link
...
- Attempt to add preloading of board items during the board load, hopefully this will improve loading times.
...
- Correct add button not being visible on desktop
